...
<div class="main container">
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <c:forEach var="Exs" items="${Exs}" begin="0" end="3">
                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div>
                        <img src="${path}/${Exs.image}">
                        <span>${Exs.position}:${Exs.name}</span>
                        <p class="text-left">
                                <%--限制输入的介绍字数--%>
                            <c:if test="${fn:length(Exs.description)>45}">
                                ${fn:substring(Exs.description,0 ,45 )}
                            </c:if>
                            <c:if test="${fn:length(Exs.description)<=45}">
                                ${Exs.description}
                            </c:if>
