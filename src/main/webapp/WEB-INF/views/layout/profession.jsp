        ...
        <c:if test="${var.developmentDirection!=var2}">
            ...
            <div class="row">
                ...
                <c:forEach var="pro" items="${pro}">
                    <c:if test="${pro.developmentDirection==var2}">
                            ...
                            <div class="warp-border">
                                <div class="clearfix">
                                    ...
                                    <div class="text">
                                        ...
                                        <p class="text-present">${pro.description}</p>
                                    </div>
                                </div>
                                ...
                                <div class="warp-class2">
                                    <div class="warp-class2-text">
                                        <div class="iconfont text-padding">门槛
                                                <%--动态输出星星图片--%>
                                            <c:forEach begin="1" end="${pro.limitCondition}">
                                ...
                                <div class="warp-class2">
                                    <div class="warp-class2-text">
                                        <div class="iconfont text-padding">成长周期 <span class="iconfont-color">${pro.growthCycle}</span>年
                                        </div>
                                    </div>
                                    <div class="warp-class2-text">
                                        <div class="iconfont text-padding text-border-left">稀缺程度 <span
                                                class="iconfont-color">${pro.scarcity}</span>家公司需要
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="warp-class2">
                                    ...
                                    <div class="rightWarp">
                                        <div class="rightWarp-class">
                                            ...
                                            <div class="rightWarp-wages">${pro.salaryStart}k-${pro.salaryEnd}k/月</div>
                                        </div>
                                        <div class="rightWarp-class">
                                ...
                                <div class="warp-class2">
                                    <b class="text-b">有${pro.numberOfStudent}人正在学</b>
                                </div>
                                <div class="warp-class2">
                                ...
                                <div class="flip-container">
                                    ...
                                    <p class="flip-text">${pro.description}</p>
                                </div>
                            </div>
                        </div>
                    </c:if>
